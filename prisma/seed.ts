...
function parseDate(value?: string): Date | null {
  ...
  // Gère le cas "0000-08-31" (birthday sans année)
...
async function seedCharacter(enData: CharacterData, translations: { lang: string; data: CharacterData }[]) {
...
async function main() {
  ...
  for (const charName of languages) {
    ...
    await seedCharacter(enData, translations);
  }
